...
<head>
    ...
    <title data-t="home.terms_title" data-t-type="title">{{ __('home.terms_title') }} — Nexus</title>
...
<header class="hero">
    <div class="container reveal">
        <h1 data-t="home.terms_title">{{ __('home.terms_title') }}</h1>
        <p data-t="home.terms_hero_desc">{{ __('home.terms_hero_desc') }}</p>
    </div>
</header>
...
<main class="container">
    <section class="section-focus reveal">
        <div class="focus-text">
            <h2 data-t="home.user_conduct">{{ __('home.user_conduct') }}</h2>
            <p data-t="home.user_conduct_desc">{{ __('home.user_conduct_desc') }}</p>
        </div>
        <div class="focus-visual">
            <i class="fas fa-user-shield visual-icon"></i>
        </div>
    </section>

    <section class="section-focus flipped reveal">
        <div class="focus-text">
            <h2 data-t="home.content_ownership">{{ __('home.content_ownership') }}</h2>
            <p data-t="home.content_ownership_desc">{{ __('home.content_ownership_desc') }}</p>
        </div>
        <div class="focus-visual">
            <i class="fas fa-file-contract visual-icon"></i>
        </div>
    </section>

    <section class="section-focus reveal">
        <div class="focus-text">
            <h2 data-t="home.account_security">{{ __('home.account_security') }}</h2>
            <p data-t="home.account_security_desc">{{ __('home.account_security_desc') }}</p>
        </div>
        <div class="focus-visual">
            <i class="fas fa-key visual-icon"></i>
        </div>
    </section>

    <section class="section-focus flipped reveal">
        <div class="focus-text">
            <h2 data-t="home.termination">{{ __('home.termination') }}</h2>
            <p data-t="home.termination_desc">{{ __('home.termination_desc') }}</p>
        </div>
        <div class="focus-visual">
            <i class="fas fa-user-slash visual-icon"></i>
        </div>
    </section>
</main>
